...
<!--===============================================================================================-->
    ...
    <!--Include thu vien quan ly Cart - AngularJS -->
    <script src="{{ asset('vendor/ngCart/dist/ngCart.js') }}"></script>

    <script>
    //Khoi tao ung dung AngularJS, su dung plugin ngCart
    //Do Laravel va AngularJS deu su dung 'Double bracket' de render du lieu
    //=>de tranh bi xung dot cu phap, ta se doi cu phap render du lieu AngularJS thanh <% %>
